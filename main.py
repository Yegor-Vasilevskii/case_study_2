#Developers:
#Mahanov S (%), Pestretsova M (40%), Pokareva C (30%), Vasilevskiy Y (65%)
...
def  tax_for_lonely_parents(b):
    if b > 0 and b <= 12950:
        ...
        return 0.1 * 12950 + (b - 12950) * 0.15
    elif b > 49400 and b <= 127550:
        return 0.1 * 12950 + (49400 - 12950) * 0.15 + (b - 49400) * 0.25
    elif b > 127550 and b <= 206600:
        return 0.1 * 12950 + (49400 - 12950) * 0.15 + (127550 - 49400) * 0.25 + (b - 127550) * 0.28
    elif b > 206600 and b <= 405100:
        return 0.1 * 12950 + (49400 - 12950) * 0.15 + (127550 - 49400) * 0.25 + (186350 - 127550) * 0.28 + (b - 206600) * 0.33
    elif b > 405100 and b <= 432200:
        return 0.1 * 12950 + (49400 - 12950) * 0.15 + (127550 - 49400) * 0.25 + (186350 - 127550) * 0.28 + (405100 - 206600) * 0.33 + (b - 405100) * 0.35
    else:
        return 0.1 * 12950 + (49400 - 12950) * 0.15 + (127550 - 49400) * 0.25 + (186350 - 127550) * 0.28 + (405100 - 206600) * 0.33 + (432200 - 405100) * 0.35 + (b - 432200) * 0.396
